          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li><a href="views/provedor.php">PROVEEDORES</a></li>
                <li><a href="views/stock.php">STOCK</a></li>
                <li><a href="views/producto.php">INGRESAR PRODUCTO</a></li>
                <li><a href="views/logout.php" class="glyphicon glyphicon-off"></a></li>
